# Install script for directory: /home/eren/robotcraft_maze_solver/src/scan_tools/laser_scan_merger
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/eren/robotcraft_maze_solver/build/scan_tools/laser_scan_merger/catkin_generated/installspace/laserscan_merger.pc")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/laserscan_merger/cmake" TYPE FILE FILES
    "/home/eren/robotcraft_maze_solver/build/scan_tools/laser_scan_merger/catkin_generated/installspace/laserscan_mergerConfig.cmake"
    "/home/eren/robotcraft_maze_solver/build/scan_tools/laser_scan_merger/catkin_generated/installspace/laserscan_mergerConfig-version.cmake"
    )
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/laserscan_merger" TYPE FILE FILES "/home/eren/robotcraft_maze_solver/src/scan_tools/laser_scan_merger/package.xml")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/laserscan_merger/launch" TYPE DIRECTORY FILES "/home/eren/robotcraft_maze_solver/src/scan_tools/laser_scan_merger/launch/")
endif()
